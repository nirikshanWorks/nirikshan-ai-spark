...
function extractSlugs(tsContent) {
  // Very small heuristic: capture occurrences of `slug: "..."` and return unique values
...
function buildUrls(slugs) {
  ...
  // core static routes commonly present in the site
  ...
  // Add expertise category & service slugs under /expertise
  slugs.forEach(s => {
