...
const ManoramaAccountDeletionPolicy = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Manorama KrishiRakshak - Account Deletion Policy"
        description="Learn how users can request account deletion and data removal for the Manorama KrishiRakshak mobile application."
        canonical="https://nirikshanai.com/projects/manorma-krishi-rakshak/account-deletion-policy"
      />
      <Navigation />
        ...
        <section className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto space-y-8">
            <header>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Manorama KrishiRakshak Account Deletion Policy</h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                This policy explains how users can request deletion of their account and related personal data from the
                Manorama KrishiRakshak app and associated backend services.
              </p>
            ...
            <section className="rounded-2xl border border-primary/30 bg-primary/5 p-6 md:p-8">
              ...
              <Link to="/projects/manorma-krishi-rakshak/privacy" className="text-primary font-semibold hover:underline block mt-2">
                View Privacy Notice
              </Link>
            </section>
          </div>
...
export default ManoramaAccountDeletionPolicy;
