...
const HostelPrivacy = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Hostel Student Tracking System - Privacy Notice"
        description="Read the dedicated privacy notice for the Hostel Student Tracking System and how user data is collected, used, and protected."
        canonical="https://nirikshanai.com/projects/hostel-student-tracking-system/privacy"
      />
      <Navigation />
        ...
        <section className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto space-y-8">
            <header>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Hostel Student Tracking System Privacy Notice</h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                The Hostel Student Tracking System values user privacy and applies role-based controls to limit access to
            ...
            <section className="rounded-2xl border border-primary/30 bg-primary/5 p-6 md:p-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link
                  to="/projects/hostel-student-tracking-system/account-deletion-policy"
                  className="text-primary font-semibold hover:underline"
                >
