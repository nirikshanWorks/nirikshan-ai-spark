...
const HostelTerms = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Hostel Student Tracking System - Terms & Conditions"
        description="Read the dedicated terms and conditions for the Hostel Student Tracking System application."
        canonical="https://nirikshanai.com/projects/hostel-student-tracking-system/terms"
      />
      <Navigation />
        ...
        <section className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto">
            <header className="mb-10">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-5">Hostel Student Tracking System Terms & Conditions</h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                By using the Hostel Student Tracking System application and associated backend services, you agree to the
                following terms.
              </p>
